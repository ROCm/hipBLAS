...
template <typename T>
hipblasStatus_t testing_syrk_strided_batched(Arguments argus)
{
    bool FORTRAN = argus.fortran;
    auto hipblasSyrkStridedBatchedFn = FORTRAN ? hipblasSyrkStridedBatched<T, true> : hipblasSyrkStridedBatched<T, false>;
