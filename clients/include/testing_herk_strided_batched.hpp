...
hipblasStatus_t testing_herk_strided_batched(Arguments argus)
{
    bool FORTRAN = argus.fortran;
    auto hipblasHerkStridedBatchedFn = FORTRAN ? hipblasHerkStridedBatched<T, U, true> : hipblasHerkStridedBatched<T, U, false>;
