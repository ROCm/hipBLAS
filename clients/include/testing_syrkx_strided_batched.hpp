...
template <typename T>
hipblasStatus_t testing_syrkx_strided_batched(Arguments argus)
{
    bool FORTRAN = argus.fortran;
    auto hipblasSyrkxStridedBatchedFn = FORTRAN ? hipblasSyrkxStridedBatched<T, true> : hipblasSyrkxStridedBatched<T, false>;
