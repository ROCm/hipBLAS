...
template <typename T>
hipblasStatus_t testing_hbmv_strided_batched(Arguments argus)
{
    bool FORTRAN = argus.fortran;
    auto hipblasHbmvStridedBatchedFn = FORTRAN ? hipblasHbmvStridedBatched<T, true> : hipblasHbmvStridedBatched<T, false>;
    ...
    {
        status = hipblasHbmvStridedBatchedFn(handle,
                                              uplo,
                                              N,
                                              K,
                                              (T*)&alpha,
