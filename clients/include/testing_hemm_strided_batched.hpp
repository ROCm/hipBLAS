...
template <typename T>
hipblasStatus_t testing_hemm_strided_batched(Arguments argus)
{
    bool FORTRAN = argus.fortran;
    auto hipblasHemmStridedBatchedFn = FORTRAN ? hipblasHemmStridedBatched<T, true> : hipblasHemmStridedBatched<T, false>;
