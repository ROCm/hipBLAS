...
*/
     ...
     */
     template<typename T>
     hipblasStatus_t
     hipblasScal(hipblasHandle_t handle,
         int n,
         const T *alpha,
         T *x, int incx);
     ...
     template<typename T>
     hipblasStatus_t
     hipblasCopy(hipblasHandle_t handle,
         int n,
         const T *x, int incx,
         T *y, int incy);
     ...
     template<typename T>
     hipblasStatus_t
     hipblasSwap(hipblasHandle_t handle,
         int n,
         T *x, int incx,
         T *y, int incy);
     ...
     template<typename T>
     hipblasStatus_t
     hipblasDot(hipblasHandle_t handle,
         int n,
         const T *x, int incx,
         const T *y, int incy,
         T *result);
     ...
     hipblasStatus_t
     hipblasAsum(hipblasHandle_t handle,
         int n,
         const T1 *x, int incx,
         T2 *result);
     ...
     template<typename T1, typename T2>
     hipblasStatus_t
     hipblasNrm2(hipblasHandle_t handle,
         int n,
         const T1 *x, int incx,
         T2 *result);
     ...
     template<typename T>
     hipblasStatus_t
     hipblasAmin(hipblasHandle_t handle,
         int n,
         const T *x, int incx,
         int *result);
     ...
     template<typename T>
     hipblasStatus_t
     hipblasAxpy(hipblasHandle_t handle,
         int n,
         const T *alpha,
         const T *x, int incx,
         T *y, int incy);
     ...
     template<typename T>
     hipblasStatus_t
     hipblasGer(hipblasHandle_t handle,
              int m, int n,
              const T *alpha,
              const T *x, int incx,
              const T *y, int incy,
    ...
    template<typename T>
    hipblasStatus_t
    hipblasSymv(hipblasHandle_t handle,
    ...
    hipblasStatus_t hipblasGemmStridedBatched(
        ...
        int m, int n, int k,
        const T *alpha,
        const T *A, int lda, int bsa,
        const T *B, int ldb, int bsb,
        const T *beta,
        T *C, int ldc, int bsc,
        int batch_count);
    ...
    template<typename T>
    hipblasStatus_t
    hipblasTrtri(hipblasHandle_t handle,
        hipblasFillMode_t uplo,
    ...
    template<typename T>
    hipblasStatus_t
    hipblasTrtri_batched(hipblasHandle_t handle,
        hipblasFillMode_t uplo,
        hipblasDiagType_t diag,
        int n,
        T *A, int lda, int bsa,
        T *invA, int ldinvA, int bsinvA,
        int batch_count);

    template<typename T, int NB>
    hipblasStatus_t
    hipblasTrtri_trsm(hipblasHandle_t handle,
        hipblasFillMode_t uplo, hipblasDiagType_t diag,
        int n,
        T *A, int lda,
        T *invA);
