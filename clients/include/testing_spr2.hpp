...
template <typename T>
hipblasStatus_t testing_spr2(Arguments argus)
{
    ...
    {
        status = hipblasSpr2Fn(handle, uplo, N, (T*)&alpha, dx, incx, dy, incy, dA);
    ...
    if(argus.unit_check)
    {
        /* =====================================================================
           CPU BLAS
        =================================================================== */
        cblas_spr2<T>(uplo, N, alpha, hx.data(), incx, hy.data(), incy, hA_cpu.data());
