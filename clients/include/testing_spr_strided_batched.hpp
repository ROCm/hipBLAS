...
template <typename T>
hipblasStatus_t testing_spr_strided_batched(Arguments argus)
{
    bool FORTRAN = argus.fortran;
    auto hipblasSprStridedBatchedFn = FORTRAN ? hipblasSprStridedBatched<T, true> : hipblasSprStridedBatched<T, false>;
