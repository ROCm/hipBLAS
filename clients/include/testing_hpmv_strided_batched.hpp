...
template <typename T>
hipblasStatus_t testing_hpmv_strided_batched(Arguments argus)
{
    bool FORTRAN = argus.fortran;
    auto hipblasHpmvStridedBatchedFn = FORTRAN ? hipblasHpmvStridedBatched<T, true> : hipblasHpmvStridedBatched<T, false>;
