...
typedef std::tuple<vector<int>, vector<double>, char, char, double, int, bool> her2k_tuple;
...
const vector<char> transA_range = {'N', 'C'};
...
Arguments setup_her2k_arguments(her2k_tuple tup)
{
...
INSTANTIATE_TEST_CASE_P(hipblasHer2k,
                        blas2_her2k_gtest,
