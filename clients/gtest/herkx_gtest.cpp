...
typedef std::tuple<vector<int>, vector<double>, char, char, double, int, bool> herkx_tuple;
...
Arguments setup_herkx_arguments(herkx_tuple tup)
{
...
INSTANTIATE_TEST_CASE_P(hipblasHerkx,
                        blas2_herkx_gtest,
