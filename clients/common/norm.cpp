...
template<>
double norm_check_symmetric<float>(char norm_type, char uplo, int N, int lda, float *hCPU, float *hGPU)
{
//norm type can be M', 'I', 'F', 'l': 'F' (Frobenius norm) is used mostly
...
template<>
double norm_check_symmetric<double>(char norm_type, char uplo, int N, int lda, double *hCPU, double *hGPU)
{
//norm type can be M', 'I', 'F', 'l': 'F' (Frobenius norm) is used mostly
