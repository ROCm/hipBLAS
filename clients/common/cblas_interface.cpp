...
extern "C" {
    ...
    //nrm2
    template<>
    void cblas_nrm2<float, float>( int n,
                            const float *x, int incx,
                            float *result)
    {
    ...
    template<>
    void cblas_nrm2<double, double>( int n,
                             const double *x, int incx,
                             double *result)
    {
    ...
    //asum
    template<>
    void cblas_asum<float, float>( int n,
                            const float *x, int incx,
                            float *result)
    {
    ...
    template<>
    void cblas_asum<double, double>( int n,
                             const double *x, int incx,
                             double *result)
    {
    ...
    template<>
    void cblas_gemv<float>( hipblasOperation_t transA, int m, int n,
                            float alpha,
                            float *A, int lda,
                            float *x, int incx,
    ...
    template<>
    void cblas_gemv<double>(hipblasOperation_t transA, int m, int n,
                            double alpha,
                            double *A, int lda,
                            double *x, int incx,
    ...
    template<>
    void cblas_symv<double>(hipblasFillMode_t uplo, int n,
                            double alpha,
                            double *A, int lda,
                            double *x, int incx,
                            double beta, double *y, int incy)
    ...
    template<>
    void cblas_ger<double>(int m, int n,
                            double alpha,
                            double *x, int incx,
                            double *y, int incy,
                            double *A, int lda)
    ...
    template<>
    void cblas_gemm<double>(hipblasOperation_t transA, hipblasOperation_t transB,
                            int m, int n, int k,
    ...
    //trsm
    template<>
    void cblas_trsm<float>( hipblasSideMode_t side, hipblasFillMode_t uplo,
    ...
    template<>
    void cblas_trsm<double>(hipblasSideMode_t side, hipblasFillMode_t uplo,
                            hipblasOperation_t transA, hipblasDiagType_t diag,
                            int m, int n,
                            double alpha,
    ...
    //trtri
    template<>
    int cblas_trtri<float>(char uplo, char diag,
                            int n,
                            float *A, int lda)
    {
        //just directly cast, since transA, transB are integers in the enum
    ...
    template<>
    int cblas_trtri<double>(char uplo, char diag,
                            int n,
                            double *A, int lda)
    {
        //just directly cast, since transA, transB are integers in the enum
    ...
    //trmm
    template<>
    void cblas_trmm<float>( hipblasSideMode_t side, hipblasFillMode_t uplo,
                            hipblasOperation_t transA, hipblasDiagType_t diag,
                            int m, int n,
                            float alpha,
                            const float *A, int lda,
    ...
    template<>
    void cblas_trmm<double>(hipblasSideMode_t side, hipblasFillMode_t uplo,
                            hipblasOperation_t transA, hipblasDiagType_t diag,
                            int m, int n,
                            double alpha,
                            const double *A, int lda,
